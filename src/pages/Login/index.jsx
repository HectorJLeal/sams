...
const LoginPage = () => {
  ...
  <section className={`${isShowLoadingPage ? "hidden" : "h-screen w-screen"}`}>
    <div className="flex flex-col items-center justify-start my-16 h-full w-full gap-4">
        <FrameFullWidth 
            ...
            textClassname="text-end w-10/12 text-xs mr-5"
            bgImage={""} 
        />
        ...
        <div className="hidden md:flex md:justify-center md:items-center md:w-full md:h-3/6 md:gap-1">
            ...
            <div className="grid grid-rows-2 w-6/12 h-full">
